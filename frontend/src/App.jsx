...
import CallButtonFloat from './components/ui/CallButtonFloat'
...
function WhatsAppFloat() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 w-12 h-12 flex items-center justify-center shadow-lg transition-transform duration-250 hover:scale-105"
      style={{ background: '#25D366', borderRadius: '50%', boxShadow: '0 4px 16px rgba(37,211,102,0.35)' }}
    >
